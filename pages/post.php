...
<?php while ($posts = mysqli_fetch_assoc($result_posts)) : ?>
  ...
  <div class="container w-full max-w-6xl mx-auto bg-white bg-cover mt-8 rounded-xl" style="background-image:url('<?= $posts['img']; ?>'); height: 75vh;"></div>

  <div class="container max-w-5xl mx-auto -mt-32">

    <div class="mx-0 sm:mx-6">

      <div class="bg-white w-full p-8 md:p-24 text-xl md:text-2xl text-gray-800 leading-normal rounded-xl border border-slate-200" style="font-family:Georgia,serif;">
